...
def exit():
	...
	write_conf(uid_now,filename = 'conf/trans_now.json')
	jobs = []
...
if __name__=='__main__':
	...
	config = read_conf('conf/trans_all.json')
	now  = read_conf('conf/trans_now.json')
	...
	# log初始化
	filename = 'data/'+uid_now+'_trans_all.log'
